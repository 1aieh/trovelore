...
import { fetchOrderById, fetchBlocks, fetchBuyers, upsertOrder } from "@/lib/supabaseClient"
  ...
  const loadFormData = async () => {
    ...
    try {
      ...
      if (orderData.products) {
        try {
          const parsedProducts = typeof orderData.products === 'string' 
                  ...
                  <div className="space-y-4 border rounded-md p-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <DatePicker
                          date={order.date_p1 ? new Date(order.date_p1) : undefined}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <Label htmlFor="payment_2">Second Payment</Label>
                        <Input
                          id="payment_2"
                          type="number"
                          min="0"
                          step="0.01"
                          value={order.payment_2 || 0}
                          onChange={(e) => handleChange("payment_2", parseFloat(e.target.value) || 0)}
                        />
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor="date_p2">Payment Date</Label>
                        <DatePicker
                          date={order.date_p2 ? new Date(order.date_p2) : undefined}
                          setDate={(date) => handleChange("date_p2", date?.toISOString())}
                        />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <Label htmlFor="payment_3">Third Payment</Label>
                        <Input
                          id="payment_3"
                          type="number"
                          min="0"
                          step="0.01"
                          value={order.payment_3 || 0}
                          onChange={(e) => handleChange("payment_3", parseFloat(e.target.value) || 0)}
                        />
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor="date_p3">Payment Date</Label>
                        <DatePicker
                          date={order.date_p3 ? new Date(order.date_p3) : undefined}
                          setDate={(date) => handleChange("date_p3", date?.toISOString())}
                        />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <Label htmlFor="payment_4">Fourth Payment</Label>
                        <Input
                          id="payment_4"
                          type="number"
                          min="0"
                          step="0.01"
                          value={order.payment_4 || 0}
                          onChange={(e) => handleChange("payment_4", parseFloat(e.target.value) || 0)}
                        />
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor="date_p4">Payment Date</Label>
                        <DatePicker
                          date={order.date_p4 ? new Date(order.date_p4) : undefined}
                          setDate={(date) => handleChange("date_p4", date?.toISOString())}
                        />
                      </div>
                    </div>
                  </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      value={order.received || "No"}
                      onValueChange={(value) => handleChange("received", value)}
                    >
                      <SelectTrigger>
                        <SelectValue placeholder="Has the order been received?" />
                      </SelectTrigger>
                      <SelectContent>
